...
{
    [ExecuteInEditMode]
    [AddComponentMenu("UI/Image Modifier")]
    public class ImageModifier : Image
    {
        ...
        private static Material DefaultProceduralImageMaterial
        {
            get
            {
                ...
                {
                    materialInstance = new Material(Shader.Find("UI/ProceduralUIImage"));
                }
        ...
        protected BaseModifier Modifier
        {
            get
            {
                if (modifier == null)
                {
                    modifier = this.GetComponent<BaseModifier>();
                    if (modifier == null)
                    {
                        ModifierType = typeof(Free);
                    }
                }
                return modifier;
            }
        ...
        public System.Type ModifierType
        {
            ...
            set
            {
                ...
                {
                    if (this.GetComponent<BaseModifier>() != null)
                    {
                        DestroyImmediate(this.GetComponent<BaseModifier>());
                    }
